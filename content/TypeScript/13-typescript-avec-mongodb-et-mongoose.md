# 1️⃣3️⃣ TypeScript avec MongoDB et Mongoose
...
// 10. Export
export const User = mongoose.model<UserDocument, IUserModel>("User", userSchema)
```
...
export class UserService {
  ...
  async update(id: string, updates: Partial<IUser>): Promise<UserDocument | null> {
...
export const Tournament = mongoose.model<TournamentDocument>("Tournament", tournamentSchema)
```
